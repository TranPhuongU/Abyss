...
public class CharacterStats : MonoBehaviour
{
   ...
   public virtual void IncreaseStatBy(float _buffPercent, float _duration, Stat _statToModify)
    {
        // start corototuine for stat increase
        StartCoroutine(StatModCoroutine(_buffPercent, _duration, _statToModify));
    }

    private IEnumerator StatModCoroutine(float _buffPercent, float _duration, Stat _statToModify)
    {
        int damageBuffPercent = Mathf.RoundToInt((_statToModify.GetValue()) * _buffPercent);

        _statToModify.AddModifier(damageBuffPercent);

        yield return new WaitForSeconds(_duration);

        _statToModify.RemoveModifier(damageBuffPercent);
    }
    ...
    public virtual void DoDamageRate(CharacterStats _targetStats, float _rate)
    {
        bool criticalStrike = false;
        ...
        int totalDamage = Mathf.RoundToInt((damage.GetValue() + strength.GetValue()) * _rate) ;
    ...
    public virtual void DoMagicalDamage(CharacterStats _targetStats)
    {
        ...
        int totalMagicalDamage = _fireDamage + _iceDamage + _lightingDamage + intelligence.GetValue() * 3;
        ...
        _targetStats.TakeDamage(totalMagicalDamage, Color.magenta);
    ...
    public virtual void DoMagicalDamageRate(CharacterStats _targetStats, float _rate)
    {
        int _fireDamage = fireDamage.GetValue();
        int _iceDamage = iceDamage.GetValue();
        int _lightingDamage = lightingDamage.GetValue();
        ...
        int totalMagicalDamage = Mathf.RoundToInt((_fireDamage + _iceDamage + _lightingDamage + intelligence.GetValue() * 3) * _rate) ;
    ...
    protected void AttemptyToApplyAilements(CharacterStats _targetStats, int _fireDamage, int _iceDamage, int _lightingDamage)
    {
    ...
    private void ApplyIgniteDamage()
    {
        ...
        {
            DecreaseHealthBy(igniteDamage, Color.red);
    ...
    protected virtual void DecreaseHealthBy(int _damage, Color _color)
    {
